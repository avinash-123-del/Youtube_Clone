...
import ytLogo from '@/app/youtube_lite/images/yt-logo.png'
import Loader from '../shared/loader';
import ytLogoMobile from '@/app/youtube_lite/images/yt-logo-mobile.png'
            ...
            <div className='flex items-center'>
                <div className="hidden md:flex">
                    ...
                    <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4">
                        <Image src="https://xsgames.co/randomusers/assets/avatars/female/67.jpg" width={50} height={50} alt='avtar' />
                    </div>
            </div>
        </div>
    )
